...
try:
   #boto3
   sqs = boto3.resource('sqs',aws_access_key_id =  'xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx',
...
""" 
   ...
   #insertion of data
   insert_data = """ copy landmarks(name,gid,address,date_built,architect,landmark,latitude,longitude) FROM '/home/administrator/Desktop/comp-851/project/Individual_Landmarks.csv' DELIMITERS ',' CSV HEADER """
